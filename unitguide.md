...
|:-------------------------------------------------------------------------------|:---------:|
| 1. Demonstrate a broad and coherent knowledge and understanding of the underlying principles and core concepts of Internetworking and Network Security, including:<br>a) Appreciation of the interplay between theory and practice
b) Awareness of the broad applicability of computing
c) Appreciation of domain-specific knowledge, including:<br>
